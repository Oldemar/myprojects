...
<div id="phtLghtBox">
	<div class="rgtCntrleft" style="width: 980px; height:510px; background: #000; padding: 0px">
		<div style="float:right; width:410px; padding-top:10px; height:500px; border-left: 1px solid #333">
			<div id="divCommentsPhoto" style="float: right; max-height: 490px; overflow-y: auto; width:400px"></div>
		...
		<div style="width:550px">	
		    ...
		    Galleria.run('#galleria',{
		        ...
		        extend: function(){
			        ...
			        this.divCommentsPhoto= function(){return $('#divCommentsPhoto');}
			        ...
			        this.bind('loadfinish', function(e) {
			            ...
			            if(this.getData().description == ''){
			   		 	...
			   		 	this.divCommentsPhoto().html(this.getData().comments_html);
