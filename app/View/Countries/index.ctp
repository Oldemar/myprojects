<div class="countries index">
	...
	<tr>
		...
		<td><?php echo h($country['Country']['fips104']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['iso2']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['iso3']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['ison']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['capital']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['nationalitysingular']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['nationalityplural']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['currency']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['currencycode']); ?>&nbsp;</td>
		<td class="actions">
