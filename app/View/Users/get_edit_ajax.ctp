								...
								<div class="fldline">
									...
									<div class="profileFld">
										<?php 
											...
											<?php echo $this->Form->button('Save', array('type'=>'button','id'=>'formsubitteduprofile', 'label'=>false)); ?>										    
									</div>
									<div class="clr"></div>
								</div>
								<!-- end uprofileEditBox -->
...
$('#uprofileListView').hide();

var todalaforma = $("#UserIndexForm").serialize() ;
</script>								
...
echo 'after ajax. '.$uprofiledata;

echo $this->Js->get('#formsubitteduprofile')->event('click', 
