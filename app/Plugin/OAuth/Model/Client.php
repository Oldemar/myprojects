 ...
 */
	...
	public function findKeyByUserIdAndURI($param = array()){
		
		if(is_array($param) && count($param) > 0){
			
			return $this->find('first', array('conditions' => array('Client.user_id' => $param['Client']['user_id'], 'Client.redirect_uri' => $param['Client']['redirect_uri'])));
		}
