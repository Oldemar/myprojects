 ...
 */
	public function add() {
		...
		$countryRes = $this->Country->CountryRe->find('list');
		$countryBuses = $this->Country->CountryBus->find('list');
		$countryBirths = $this->Country->CountryBirth->find('list');
		$this->set(compact('countryRes', 'countryBuses', 'countryBirths'));
	}
