...
/**
 * 
 * @modified by: Pedro Garcia
 * @version: 0.2.3
 * 
 * Regarding to the Alpha registration requirements. This class has been modified at
 * 
 * @var: class name: MathCaptComponent
 * 
 * @var: $placeholders line 110
 * 
 * @var: $choices line 57
 * 
 ...
 * @filesource
 */
class MathCaptComponent extends Component {
  ...
  * @var array
  * 
  * The origin array was modified regarding to the current requirements.
  * 
  * @author: Pedro Garcia
  * 
  */
  ...
  private $placeholders = array(
    ...
    ".:number:." => array(
      ...
      "five" => 5),
  		...
  		//Fix the Alpha registration requirements
      ".:operator:." => array(
      	"+" => "+",
      	"+" => "+",
      	"+" => "+",
